...
const SteamIdForm = () => {
  ...
  return (
    <div
      className={"bg-primaryColorDark border-4 border-highlightColor flex flex-col items-center justify-center "}>
      <div className={"mt-12 w-full px-12"}>
        <Input onChange={(value) => handleOnInputChange(value)}
               value={profileUrl} type={"text"}
